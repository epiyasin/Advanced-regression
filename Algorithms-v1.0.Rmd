...
### II - Benjamini-Hochberg FDR correction
```{r message=FALSE, warning=FALSE, eval=FALSE}
...
## II - Generalised Prediction rule
...
### I - Diagonal discriminant analysis
```{r message = FALSE, warning = FALSE, eval = FALSE}
...
DDA_ranking = sda.ranking(x, y, diagonal = TRUE) # ranking features using sda function 
...
DDA_predicted = predict(DDA_rule, x[, selected_variables, drop = FALSE], verbose = FALSE)
...
LDA_predicted = predict(LDA_rule, x[, selected_variables, drop = FALSE], verbose = FALSE)
...
### I - Evaluating prediction performance of DDA cross-validation

```{r message = FALSE, warning = FALSE, eval = FALSE}
# dda
DDA_cv = crossval(prediction_function, X = x, Y = y, K, B, method = "dda", verbose = FALSE)
DDA_cv$stat
...
### II - Evaluating prediction performance of LDA cross-validation

```{r message = FALSE, warning = FALSE, eval = FALSE}
# lda
LDA_cv = crossval(prediction_function, X = x, Y = y, K, B, method = "lda", verbose = FALSE)
LDA_cv$stat
TPR[2] = LDA_cv$stat[2]/(LDA_cv$stat[2]+LDA_cv$stat[4])
TNR[2] = LDA_cv$stat[3]/(LDA_cv$stat[1]+LDA_cv$stat[3])
```

### III - Evaluating prediction performance of SVM cross-validation

```{r message = FALSE, warning = FALSE, eval = FALSE}
# svm
SVM_cv = crossval(prediction_function, X = x, Y = y, K, B, method = "svm", verbose = FALSE)
SVM_cv$stat
...
### IV - Evaluating prediction performance of random forest cross-validation

```{r message = FALSE, warning = FALSE, eval = FALSE}
# randomForest
randomforest_cv = crossval(prediction_function, X = x, Y = y, K, B, method = "randomforest", verbose = FALSE)
